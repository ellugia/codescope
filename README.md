...
For interactive local configuration and diagnostics, run `node node_modules/codescope-bridge/bin/codescope.mjs ui`. The UI manages local setup; `serve` remains the MCP stdio bridge.
